...
export default async function TrainerDietPage() {
  ...
  const [templates, plans, members] = await Promise.all([
    ...
    listDietPlans({ gymId, trainerId: user.id }),
    listMembersForDiet(gymId, user.id),
  ]);
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Build diet templates and assign them to your members.</p>
      </div>
